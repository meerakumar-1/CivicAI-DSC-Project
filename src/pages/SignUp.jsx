    ...
    <div style={{ minHeight: '100vh', background: '#030712', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 24, position: 'relative', overflow: 'hidden' }}>
      ...
      <div style={{ width: '100%', maxWidth: 420, position: 'relative', zIndex: 1 }}>
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <h2 style={{ fontSize: 22, fontWeight: 700, color: '#fff', marginBottom: 8 }}>Create your account</h2>
          <p style={{ color: '#64748b', fontSize: 14 }}>Join thousands of citizens making their city better</p>
        </div>
        ...
        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          <div>
            <label style={{ display: 'block', color: '#94a3b8', fontSize: 13, marginBottom: 8, fontWeight: 500 }}>Full Name</label>
            <input
              type="text"
              value={name}
          ...
          <div>
            <label style={{ display: 'block', color: '#94a3b8', fontSize: 13, marginBottom: 8, fontWeight: 500 }}>Confirm Password</label>
            <input
              type="password"
        ...
        <div style={{ textAlign: 'center', marginTop: 28, paddingTop: 28, borderTop: '1px solid rgba(255,255,255,0.06)' }}>
          <p style={{ color: '#64748b', fontSize: 14 }}>
            ...
            <span onClick={() => navigate('/signin')} style={{ color: '#38bdf8', cursor: 'pointer', fontWeight: 500 }}>Sign in</span>
          </p>
        </div>
